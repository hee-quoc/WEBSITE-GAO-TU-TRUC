        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-green-light-1 rounded-2xl p-8">
              <div className="mb-6">
                <Image src="/images/img_users.svg" alt="Users" width={42} height={42} />
              </div>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <Image src="/images/img_frame_434.svg" alt="Check" width={22} height={44} />
                  <span className="text-gray-light">Khách hàng lẻ<br />Mạnh thường quân</span>
                </div>
                <div className="flex items-start gap-3">
                  <Image src="/images/img_frame_394.svg" alt="Check" width={22} height={22} />
            ...
            <div className="bg-green-light-1 rounded-2xl p-8">
              <div className="mb-6">
                <Image src="/images/img_frame_392.svg" alt="Business" width={42} height={42} />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    <Image src="/images/img_frame_394.svg" alt="Check" width={30} height={22} />
