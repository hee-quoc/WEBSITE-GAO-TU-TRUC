    ...
    <section className="pt-20 pb-5 bg-white">
        <div className="max-w-7xl flex flex-col items-center mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-[732px]">
            ...
            <p className="text-[16px] sm:text-[16px] text-center text-gray-light mb-8 sm:mb-12 font-alegreya-sans" style={{ color: "#667085" }}> {/* Adjusted font sizes and margin */}
            ...
            <div className="bg-[#F4F3EA] rounded-[16px] overflow-hidden relative w-full h-[500px] sm:h-[600px] lg:w-[495px] lg:h-[642px] flex items-end"> {/* Adjusted height for smaller screens */}
              ...
              <div className="relative z-10 p-6 sm:p-10 w-full pt-10"> {/* Removed bg-gradient-to-t and text-white */}
                <div className="max-w-[194px] mb-6 sm:mb-8"> {/* Adjusted margin-bottom */}
                  <div className="text-4xl sm:text-5xl md:text-6xl font-bold mb-2 sm:mb-4 font-alegreya-sans" style={{ color: "#6D9127" }}><span style={{ color: "#FFB000" }}>&gt;</span>300</div> {/* Changed text color to #6D9127 */}
                  <p className="text-sm sm:text-base font-fz-poppins" style={{ color: "#667085" }}> {/* Changed text color to #667085 */}
                    Hộ nông dân địa phương đồng hành ổn định
                  </p>
                </div>
                <div className="max-w-[194px] mb-6 sm:mb-8"> {/* Adjusted margin-bottom */}
                ...
                <div>
                  <div className="text-4xl sm:text-5xl md:text-6xl font-bold mb-2 sm:mb-4 font-alegreya-sans" style={{ color: "#6D9127" }}>10%</div> {/* Changed text color to #6D9127 */}
                  <p className="text-sm sm:text-base font-fz-poppins" style={{ color: "#667085" }}> {/* Changed text color to #667085 */}
                    Thu nhập bình quân
                  </p>
                </div>
                <p className="text-xs sm:text-sm mt-6 sm:mt-8 font-fz-poppins" style={{ color: "#667085" }}> {/* Changed text color to #667085 */}
            ...
            <div className="flex flex-col gap-8 w-full">
              ...
              <div className="basis-[60%] flex flex-row gap-4 text-white w-full lg:w-[605px] h-auto lg:h-[311px]">
                <div className="w-1/2 bg-[#6D9127] rounded-[16px] px-6 sm:px-10 gap-6 overflow-hidden relative">
                  ...
                  <div className="relative py-6">
                    ...
                    <p className="text-green-lightest-1 font-fz-poppins opacity-80"style={{ color: "#EFF0F2" }} >
                      Hộ nông dân địa <br />phương đồng hành <br />ổn định
                    </p>
                  </div>
                </div>
                <div className="w-1/2 bg-[#F4F3EA] rounded-[16px] px-6 sm:px-10 flex flex-col justify-around">
                  <div>
              ...
              <div className="basis-[40%] rounded-[16px] px-6 sm:px-10 py-2 relative overflow-hidden bg-cover bg-center w-full lg:w-[605px] h-auto lg:h-[311px]">
                ...
                <div className="relative z-10 text-white">
                  ...
                  <p className="text-sm sm:text-base text-white font-fz-poppins opacity-80" style={{color:"#EFF0F2"}}> {/* Adjusted font sizes */}
